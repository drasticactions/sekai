...
namespace Sekai.Views
{
    ...
    public sealed partial class LoadingPage : Page
    {
        ...
        private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            {
                var cred = (string)_localSettings.Values[Constants.Credential];
                credentialStore = JsonConvert.DeserializeObject<InMemoryCredentialStore>(cred);
            }
            else
            {
            ...
            try
            {
                Locator.ViewModels.MainPageVm.Authorizer = new PinAuthorizer()
                {
                    CredentialStore = credentialStore,
                    SupportsCompression = true
                };
                Locator.ViewModels.MainPageVm.TwitterContext = new TwitterContext(Locator.ViewModels.MainPageVm.Authorizer);
                var verifyResponse =
                await
